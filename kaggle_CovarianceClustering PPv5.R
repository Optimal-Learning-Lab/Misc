...
system.time(modelob<-LKT(data=val,
                         components=c("KC..Content.","Anon.Student.Id","Anon.Student.Id","studpart"),
                         features=c("intercept","logsuc","logfail","logit"),
                         covariates = c(NA,NA,NA,"part"),
                         fixedpars=c(.03),seedpars=c(NA),interc = FALSE,epsilon=1e-6,cost=1024))
auc(modelob$newdata$CF..ansbin.,modelob$prediction)
plot.roc(modelob$newdata$CF..ansbin.,modelob$prediction)
...
system.time(modelob<-LKT(data=val,
                         components=c("KC..Content.","Anon.Student.Id","Anon.Student.Id","Anon.Student.Id","Anon.Student.Id"),
                         features=c("intercept","intercept","logsuc","logfail","logafm"),
                         # covariates = c(NA,"","",NA,NA),
                         fixedpars=c(.25),seedpars=c(NA),interc = FALSE,epsilon=1e-6,cost=1024))
auc(modelob$newdata$CF..ansbin.,modelob$prediction)
plot.roc(modelob$newdata$CF..ansbin.,modelob$prediction)

val$factask<- c("a","b")[1+(val$task_container_id<500)]
system.time(modelob<-LKT(data=val,
                         components=c("KC..Content.","Anon.Student.Id","lecs","lecs"),
                         features=c("intercept","intercept","logsuc$","logfail$"),
...
auc(modelob$newdata$CF..ansbin.[modelob$newdata$bundle_id<101],modelob$prediction[modelob$newdata$bundle_id<101])
auc(modelob$newdata$CF..ansbin.[modelob$newdata$bundle_id>1000],modelob$prediction[modelob$newdata$bundle_id>1000])
auc(modelob$newdata$CF..ansbin.[modelob$newdata$bundle_id<101],modelob$prediction[modelob$newdata$bundle_id<101])
auc(modelob$newdata$CF..ansbin.[modelob$newdata$bundle_id<101],modelob$prediction[modelob$newdata$bundle_id<101])
plot.roc(modelob$newdata$CF..ansbin.,modelob$prediction)

val$lecs <- ave(val$content_type_id==1,by=list(val$Anon.Student.Id),FUN=cumsum)
...
system.time(modelob<-LKT(data=val,
                         components=c("KC..Content.","Anon.Student.Id","AC"),
                         features=c("intercept","intercept","logitdec"),
                         # covariates = c(NA,NA,NA,"lecs","lecs"),
                         fixedpars=c(.92),seedpars=c(NA),interc = FALSE,epsilon=1e-6,cost=1024))
auc(modelob$newdata$CF..ansbin.,modelob$prediction)
plot.roc(modelob$newdata$CF..ansbin.,modelob$prediction)
